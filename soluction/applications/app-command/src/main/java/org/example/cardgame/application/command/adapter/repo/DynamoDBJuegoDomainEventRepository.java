...
@Component
public class DynamoDBJuegoDomainEventRepository implements JuegoDomainEventRepository {
    private final EventStoreRepository repository;
    private final ConfigProperties configProperties;

    public DynamoDBJuegoDomainEventRepository(EventStoreRepository repository, ConfigProperties configProperties) {
